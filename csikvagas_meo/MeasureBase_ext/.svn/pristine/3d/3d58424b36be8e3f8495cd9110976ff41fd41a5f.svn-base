...
namespace e77.MeasureBase
{
    public class SqlRecordSn : ISqlSaveable
    {
        ...
        {
            SqlTableDescriptorBase tableDesc = new SqlTableDescriptorBase(tableName_in,
                new string[] { "sn", "is_reference" }, null);
            Sql = new SqlRowDescriptor(tableDesc, this);
        }
        ...
        {
            Trace.TraceInformation("SqlRecordSn. Sn: {0}", sn);
